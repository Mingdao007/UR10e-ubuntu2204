...
class WatchdogController final : public controller_interface::ControllerInterface
{
public:
...
private:
  ...
  rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::UInt8>::SharedPtr status_publisher_;
