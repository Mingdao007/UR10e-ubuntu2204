...
| Step4E v13 直线路径 | 两张 TP Move 截图定义 XY 直线，bridge path length `143.747 mm`；Z 与姿态由 Step4E 外环 command 调整 |
...
| Step2C V4 comparison run | [../experiments/tase-contact-reproduction/runs/bridge_step2c_admittance_search30_v4_search2ms_line1ms_alpha70_20260608_135945](../experiments/tase-contact-reproduction/runs/bridge_step2c_admittance_search30_v4_search2ms_line1ms_alpha70_20260608_135945) |
| Step2C final run | [../experiments/tase-contact-reproduction/runs/bridge_step2c_final_autowatch_search2ms_line1ms_alpha70_20260608_154123](../experiments/tase-contact-reproduction/runs/bridge_step2c_final_autowatch_search2ms_line1ms_alpha70_20260608_154123) |
...
| Step4D circle run | [../experiments/tase-contact-reproduction/runs/bridge_step4d_circle_v1_autowatch_detsearch_attitude_20260608_165457](../experiments/tase-contact-reproduction/runs/bridge_step4d_circle_v1_autowatch_detsearch_attitude_20260608_165457) |
...
| Step4E v13 run | [../experiments/tase-contact-reproduction/runs/bridge_step4e_line_outerloop_v13_autowatch_20260609_141027](../experiments/tase-contact-reproduction/runs/bridge_step4e_line_outerloop_v13_autowatch_20260609_141027) |
...
图 2 单独展开 Fz。Kunwei 前 `600 s` 的 first-1s-mean-zeroed Fz 标准差是 `0.0113 N`，OnRobot UDP raw 是 `0.1541 N`。这个数值不能直接解释成传感器规格优劣，因为两个窗口的安装、载荷和日期不同。
...
|---|---:|
| run | `bridge_step4e_line_outerloop_v13_autowatch_20260609_141027` |
| line path completed | yes |
| bridge path / success threshold | `143.747 / 143.247 mm` |
| progress max | `143.618 mm` |
| first success threshold | `48.446 s` |
| final stop reason | `1.0 (line_complete)` |
| final stage | `29.0` |
| unload/retract/home evidence | `stage26 rows=572`, `stage27 rows=2,809`, `stage29 rows=133` |
...
[Step4E v13 demo video](assets/kunwei-kwr75-progress-20260608/step4e_v13_line_experiment.mp4)
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Kunwei TCP raw | Fx | 599,988 | 599.971 | 1000.027 | -0.0013 | 0.0136 | -0.0389 | 2.327 / 2.529 |
| OnRobot UDP raw | Fx | 299,756 | 599.990 | 499.600 | 0.0166 | 0.0453 | -0.0400 | 0.060 / 0.470 |
| Kunwei TCP raw | Fy | 599,988 | 599.971 | 1000.027 | -0.0036 | 0.0122 | -0.0209 | -1.216 / -1.026 |
| OnRobot UDP raw | Fy | 299,756 | 599.990 | 499.600 | 0.0329 | 0.0302 | -0.0100 | 3.000 / 3.260 |
| Kunwei TCP raw | Fz | 599,988 | 599.971 | 1000.027 | 0.0062 | 0.0113 | 0.0219 | -1.604 / -0.497 |
| OnRobot UDP raw | Fz | 299,756 | 599.990 | 499.600 | -0.0777 | 0.1541 | 0.2200 | -25.900 / -24.500 |
