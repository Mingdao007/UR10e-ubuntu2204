...
| 中期 summary JSON | [onrobot_three_stream_half_hour_20260528_summary.json](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_summary.json) |
...
![Fz overlay](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_fz_overlay_zeroed.png)
...
![URCap UDP Fz](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_fz_urcap125_udp500_compare.png)

图 3 展示 Fx/Fy/Fz 三个力轴。横向力 `Fx/Fy` 的漂移幅值和 Fz 分开看，避免只看 Fz 漏掉侧向变化。

![Force axes](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_force_axes_zeroed.png)

图 4 是每条流内部的 Fx/Fy 对照。这里的 `fxy` 指 Fx 和 Fy 两条曲线，不是水平力模长。

![Fx Fy](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_fxy_zeroed.png)

图 5 给出三个力矩轴，用于判断力矩漂移是否和力轴同时出现。

![Torque axes](assets/onrobot_three_stream_half_hour_20260528/onrobot_three_stream_half_hour_20260528_torque_axes_zeroed.png)
