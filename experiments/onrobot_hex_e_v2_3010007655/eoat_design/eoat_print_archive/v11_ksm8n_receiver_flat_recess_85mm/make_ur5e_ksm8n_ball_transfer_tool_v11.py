...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v11_ksm8n_receiver_flat_recess_85mm")
...
def write_readme(verification):
    p = PARAMS
    text = f"""# UR5e KSM-8N ball-transfer tool v11, flat-bottom recessed receiver face, 85 mm TCP
...
def main():
    ...
    stem = "ur5e_ksm8n_ball_transfer_tool_v11"
    ...
    verification = {
        "version": "v11_ksm8n_receiver_flat_recess_85mm",
        "concept": "Short direct-flange UR5e passive rolling-contact EOAT using local KSM-8N M6 ball transfer with a slim receiver and flat-bottom recessed front face.",
        "parameters": PARAMS,
        "derived": {
