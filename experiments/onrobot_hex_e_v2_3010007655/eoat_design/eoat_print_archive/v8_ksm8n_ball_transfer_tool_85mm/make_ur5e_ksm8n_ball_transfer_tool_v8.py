...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v8_ksm8n_ball_transfer_tool_85mm")
...
def write_readme(verification):
    p = PARAMS
    text = f"""# UR5e KSM-8N ball-transfer tool v8, 85 mm TCP
...
def main():
    ...
    stem = "ur5e_ksm8n_ball_transfer_tool_v8"
    ...
    verification = {
        "version": "v8_ksm8n_ball_transfer_tool_85mm",
        "concept": "Short direct-flange UR5e passive rolling-contact EOAT using local KSM-8N M6 ball transfer.",
        "parameters": PARAMS,
        "derived": {
