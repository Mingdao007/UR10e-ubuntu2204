...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v9_ksm8n_receiver_slim_85mm")
...
def write_readme(verification):
    p = PARAMS
    text = f"""# UR5e KSM-8N ball-transfer tool v9, slim receiver, 85 mm TCP
...
def main():
    ...
    stem = "ur5e_ksm8n_ball_transfer_tool_v9"
    ...
    verification = {
        "version": "v9_ksm8n_receiver_slim_85mm",
        "concept": "Short direct-flange UR5e passive rolling-contact EOAT using local KSM-8N M6 ball transfer with only the final receiver head slimmed.",
        "parameters": PARAMS,
        "derived": {
