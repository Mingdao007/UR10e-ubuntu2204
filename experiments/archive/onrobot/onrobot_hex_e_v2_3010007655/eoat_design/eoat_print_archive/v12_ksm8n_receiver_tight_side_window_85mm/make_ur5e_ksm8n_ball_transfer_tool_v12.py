...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v12_ksm8n_receiver_tight_side_window_85mm")
...
def write_readme(verification):
    p = PARAMS
    text = f"""# UR5e KSM-8N ball-transfer tool v12, tight side nut window, 85 mm TCP

This version keeps the v11 flat-bottom recessed receiver face and tightens the
side nut insertion window. The KSM-8N remains a purchased metal part; the
printed receiver keeps a captive M6 hex nut while reducing the side opening
height from about 6.2 mm to 5.0 mm for a user-measured 4.8 mm nut.
...
- `ur5e_ksm8n_ball_transfer_tool_v12_body.step / .stl`
- `ur5e_ksm8n_ball_transfer_tool_v12_ksm_placeholder.step / .stl`
- `ur5e_ksm8n_ball_transfer_tool_v12_assembly.step / .stl`
- `ur5e_ksm8n_ball_transfer_tool_v12_onepiece_preview.step / .stl`
- `ur5e_ksm8n_ball_transfer_tool_v12_receiver_fitcheck.step / .stl`
- `ur5e_ksm8n_ball_transfer_tool_v12_flange_fitcheck.step / .stl`
...
- The side window is 5.0 mm high for a measured 4.8 mm M6 nut, leaving smaller top/bottom lips around the opening.
...
def main():
    ...
    stem = "ur5e_ksm8n_ball_transfer_tool_v12"
    ...
    verification = {
        "version": "v12_ksm8n_receiver_tight_side_window_85mm",
        "concept": "Short direct-flange UR5e passive rolling-contact EOAT using local KSM-8N M6 ball transfer with a slim receiver, flat-bottom recessed front face, and tighter side nut window.",
        "parameters": PARAMS,
        "derived": {
        ...
        "assumptions_to_confirm": [
            ...
            "The 5.0 mm side nut window assumes the user's measured M6 nut height is about 4.8 mm; print receiver_fitcheck first to confirm insertion is not too tight.",
