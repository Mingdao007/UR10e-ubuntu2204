...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v7_ksm8n_ball_transfer_tool")
...
PARAMS = {
    ...
    "base_body_height_mm": 40.0,
    "transition_height_mm": 18.0,
    "neck_diameter_mm": 30.0,
    "receiver_diameter_mm": 32.0,
    "receiver_height_mm": 18.0,
    ...
    # Target.
    "contact_point_from_flange_face_mm": 140.0,
}
...
def write_readme(verification):
    p = PARAMS
    text = f"""# UR5e KSM-8N ball-transfer tool v7
...
- Contact module: KSM-8N placeholder, ball diameter {p["ksm_ball_diameter_mm"]:.1f} mm
...
def main():
    ...
    assembly = Part.makeCompound([body, ksm])
    onepiece_preview = body.fuse(ksm)
    ...
    stem = "ur5e_ksm8n_ball_transfer_tool_v7"
    ...
    verification = {
        "version": "v7_ksm8n_ball_transfer_tool",
        "concept": "Complete direct-flange UR5e passive rolling-contact EOAT using local KSM-8N M6 ball transfer.",
        "parameters": PARAMS,
        "derived": {
        ...
        "validation": {
            "contact_point_target_mm": 140.0,
            "contact_point_error_mm": positions["contact_z"] - 140.0,
