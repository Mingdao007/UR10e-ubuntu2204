...
VERSION_DIR = Path("/Users/andyl/Documents/UR5e/eoat/eoat_print/v6_slim_adapter_72mm")
...
def main():
    ...
    save_shape(body, "ur5e_flat_pad_tool_v6_slim_adapter_body")
    save_shape(pad, "ur5e_flat_pad_tool_v6_slim_adapter_pad")
    save_shape(fitcheck, "ur5e_flat_pad_tool_v6_slim_adapter_fitcheck")
    save_shape(assembly, "ur5e_flat_pad_tool_v6_slim_adapter_assembly")
    save_shape(onepiece, "ur5e_flat_pad_tool_v6_slim_adapter_onepiece")

    contact_face_z = onepiece.BoundBox.ZMax
    verification = {
        "version": "v6_slim_adapter_72mm",
        "concept": "Paper-like direct-mount UR5e flat-pad contact tool with a slimmer 72 mm adapter OD.",
        "parameters": PARAMS,
        "derived": {
        ...
        "assumptions_to_confirm": [
            ...
            "UR5e center locating register/recess diameter is still assumed as 31.7 mm and should be checked on the bare flange.",
            "The smooth OnRobot QC-R locating pin is not copied in this direct UR5e flange version.",
    ...
    readme = f"""# UR5e flat-pad tool v6 slim adapter, 72 mm OD
...
- Adapter 外径：{PARAMS["adapter_outer_diameter_mm"]:.1f} mm
...
- Counterbore 外缘到 adapter 外缘的径向余量：{verification["derived"]["outer_edge_margin_after_counterbore_mm"]:.1f} mm
...
"""
    ...
    print(VERSION_DIR / "ur5e_flat_pad_tool_v6_slim_adapter_onepiece.step")
