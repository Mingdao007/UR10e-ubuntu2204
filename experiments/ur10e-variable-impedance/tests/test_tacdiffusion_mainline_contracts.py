...
class ActionAndExpertTests(unittest.TestCase):
    def test_12d_action_k_bounds_slew_and_damping(self):
        ...
        self.assertLessEqual(math.sqrt(sum(value * value for value in action.raw_f_df[:3])), 50.0)
        self.assertLessEqual(action.raw_f_df[3], 4.0)
        self.assertEqual(profile.force_component_abs_max, (50.0, 50.0, 50.0, 4.0, 4.0, 4.0))
        self.assertEqual(profile.force_slew_per_s, (100.0, 100.0, 100.0, 10.0, 10.0, 10.0))
