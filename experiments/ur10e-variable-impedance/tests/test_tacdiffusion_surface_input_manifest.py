...
class SurfaceInputManifestTests(unittest.TestCase):
    ...
    def test_manifest_is_native_json_and_records_fail_closed_status(self):
        ...
        self.assertFalse(payload["status"]["unknown_surface_episode_reference_backend_ready"])
        ...
        self.assertIn("unknown-surface nominal in-plane episode references", blockers)
