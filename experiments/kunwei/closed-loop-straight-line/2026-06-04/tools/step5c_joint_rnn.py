#!/usr/bin/env python3
"""Step5c bridge-side joint-space command solver and numeric sanity gate."""
...
class JointRnnSolver:
    """Bounded least-squares qdot solver for the Step5c joint-space bridge."""
...
def numeric_sanity(output_root: Path | None = None) -> dict[str, Any]:
    ...
    cases = [
        ...
        },
        {
            ...
            "path_cap_m_s": 0.004,
            "total_linear_cap_m_s": 0.006,
            "normal_velocity_cap_m_s": 0.003,
            "attitude_cap_rad_s": 0.060,
        },
    ]
    reports = []
    overall_pass = True
