...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v5", self.table)
        ...
        self.assertTrue(liveprep["blocked"])
        self.assertFalse(liveprep["complete"])
        self.assertFalse(liveprep["completion_target"])
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v5")
        ...
        self.assertIn("No route to host", liveprep["local_delivery_evidence"]["upload_blocked_reason"])
        self.assertIn("ARP", liveprep["local_delivery_evidence"]["upload_blocked_reason"])
        ...
        self.assertTrue(any("contact window" in gate for gate in liveprep["liveprep_gates"]))
