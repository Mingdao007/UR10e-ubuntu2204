...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v6", self.table)
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v6")
        ...
        self.assertEqual(
            ...
            "runs/controller_readback_step5d_strict_rnn_liveprep_v6_20260615_173122",
        )
        ...
        self.assertEqual(liveprep["guard"]["line_entry_normal_load_max_n"], 40.0)
        self.assertEqual(liveprep["guard"]["line_entry_force_norm_max_n"], 45.0)
        self.assertEqual(liveprep["guard"]["line_entry_required_s"], 0.05)
        ...
        self.assertIn("old logged orientation error", liveprep["semantic_control_gate"]["failure_contrast"])
        ...
        self.assertTrue(any("2-40N" in gate for gate in liveprep["liveprep_gates"]))
