...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        self.assertIn("v10", liveprep["semantic_control_gate"]["failure_contrast"])
        self.assertIn("deadband acquire", liveprep["semantic_control_gate"]["failure_contrast"])
        ...
        self.assertTrue(any("filtered 2N <= normal_load <= 15N" in gate for gate in liveprep["liveprep_gates"]))
