...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v10", self.table)
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v10")
        ...
        self.assertIn("runs/controller_readback_step5d_strict_rnn_liveprep_v10_", liveprep["local_delivery_evidence"]["controller_readback"])
        ...
        self.assertEqual(liveprep["guard"]["line_entry_normal_load_min_n"], 3.0)
        self.assertEqual(liveprep["guard"]["line_entry_normal_load_max_n"], 8.0)
        self.assertEqual(liveprep["guard"]["line_entry_force_norm_max_n"], 25.0)
        self.assertEqual(liveprep["guard"]["line_entry_required_s"], 0.3)
        self.assertEqual(liveprep["guard"]["line_entry_settle_velocity_ready_m_s"], 0.001)
        self.assertEqual(liveprep["guard"]["admittance_mass"], 12.0)
        self.assertEqual(liveprep["guard"]["admittance_damping"], 300.0)
        ...
        self.assertEqual(liveprep["contact_policy"]["admittance_settle_stage"], "25.3")
        ...
        self.assertIn("v9", liveprep["semantic_control_gate"]["failure_contrast"])
        self.assertIn("admittance", liveprep["semantic_control_gate"]["failure_contrast"])
        self.assertTrue(any("semantic gate" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("failure-contrast" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("filtered 3N <= normal_load <= 8N" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("low-load" in gate for gate in liveprep["liveprep_gates"]))
