...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v7", self.table)
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v7")
        ...
        self.assertEqual(
            ...
            "runs/controller_readback_step5d_strict_rnn_liveprep_v7_20260615_181026",
        )
        ...
        self.assertTrue(any("2N and 15N" in gate for gate in liveprep["liveprep_gates"]))
