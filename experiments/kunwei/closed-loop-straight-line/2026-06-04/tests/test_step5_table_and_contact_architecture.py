...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v2", self.table)
        ...
        self.assertEqual(liveprep["delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v2")
        self.assertTrue(liveprep["delivery_evidence"]["local_controller_readback_sha_match"])
        self.assertIn("controller_readback_step5d_strict_rnn_liveprep_v2", liveprep["delivery_evidence"]["controller_readback"])
