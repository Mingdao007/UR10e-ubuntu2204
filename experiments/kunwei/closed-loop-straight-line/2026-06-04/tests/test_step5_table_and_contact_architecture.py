...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v8", self.table)
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v8")
        ...
        self.assertEqual(
            ...
            "runs/controller_readback_step5d_strict_rnn_liveprep_v8_20260615_182826",
        )
        ...
        self.assertEqual(liveprep["guard"]["line_entry_required_s"], 0.2)
        self.assertEqual(liveprep["guard"]["line_entry_recovery_normal_load_min_n"], 0.5)
        ...
        self.assertEqual(liveprep["contact_policy"]["force_pid_settle_stage"], "25.3")
        ...
        self.assertIn("24.3", liveprep["semantic_control_gate"]["failure_contrast"])
        ...
        self.assertTrue(any("3N <= normal_load <= 8N" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("0.5N <= normal_load <= 40N" in gate for gate in liveprep["liveprep_gates"]))
