...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        liveprep = step5_table.step5_stage("step5d_strict_rnn_liveprep_v1", self.table)
        ...
        self.assertIn("controller_readback_step5d_strict_rnn_liveprep_v1", liveprep["delivery_evidence"]["controller_readback"])
