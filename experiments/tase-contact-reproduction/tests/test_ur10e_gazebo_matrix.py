...
class Ur10eGazeboMatrixTest(unittest.TestCase):
    ...
    def test_stage_contact_wrench_adapter_writer_keeps_unverified_log_visual_only(self) -> None:
        ...
        self.assertEqual(payload["observation_scope"], "same_run_stage_gazebo_row")
        self.assertEqual(payload["source_topic"], "/ur10e/contact/gazebo/step5b/contacts")
    ...
    def test_finish_contact_topic_capture_tags_stage_observation_id(self) -> None:
        ...
        self.assertEqual(payload["capture"]["observation_scope"], "same_run_stage_gazebo_row")
        self.assertEqual(payload["capture"]["sim_transport"], "ignition")
        self.assertEqual(contact_log["stage_id"], "step5b")
        self.assertEqual(contact_log["observation_id"], "stage-step5b-row-fixture-001")
        self.assertEqual(contact_log["observation_scope"], "same_run_stage_gazebo_row")
        self.assertEqual(contact_log["sim_transport"], "ignition")
        self.assertEqual(adapter["stage_id"], "step5b")
        self.assertEqual(adapter["observation_id"], "stage-step5b-row-fixture-001")
        self.assertEqual(adapter["observation_scope"], "same_run_stage_gazebo_row")
        self.assertEqual(adapter["source_topic"], "/ur10e/contact/gazebo/step5b/contacts")
