...
class Step5bGzTransportProbeTest(unittest.TestCase):
    ...
    def test_m3_wrench_integration_builds_total_contact_adapter_trace(self) -> None:
        ...
        self.assertFalse(adapter["wrench_trace"]["is_formal_acceptance"])
        self.assertEqual(adapter["wrench_trace"]["claim_tier"], "visual_only")
        self.assertEqual(adapter["wrench_trace"]["diagnostic_claim_tier"], "physical Gazebo collision/contact physics")
        self.assertFalse(adapter["wrench_trace"]["rows"][0]["is_formal_acceptance"])
        self.assertEqual(adapter["wrench_trace"]["rows"][0]["claim_tier"], "visual_only")
