...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        self.assertIn("Retained v15a live-run evidence", liveprep["block_reason"])
        self.assertIn("hold_duty_limit", liveprep["block_reason"])
        ...
        self.assertEqual(liveprep["live_run_evidence"]["stop_reason"], "step5d_contact_safety:hold_duty_limit")
        self.assertAlmostEqual(liveprep["live_run_evidence"]["stage25_duration_s"], 0.9979995499597862)
        self.assertGreater(liveprep["live_run_evidence"]["hold_duty"], liveprep["guard"]["hold_duty_limit"])
        self.assertEqual(liveprep["live_run_evidence"]["tcp_cage_reason"], "inside_broad_tcp_cage")
        self.assertLess(liveprep["live_run_evidence"]["force_norm_max_n"], liveprep["guard"]["force_norm_guard_n"])
        self.assertIn("not current", liveprep["success_condition"])
        self.assertIn("explicit same-version retry", liveprep["success_condition"])
        ...
        self.assertEqual(liveprep["contact_policy"]["live_authorization"], "retained_live_run_evidence_no_current_retry_authorization")
        ...
        self.assertEqual(liveprep["filter_policy"]["v15a_status"], "retained_live_run_evidence_hold_duty_limit")
