...
class Step5TableAndContactArchitectureTest(unittest.TestCase):
    ...
    def test_step5_table_separates_no_contact_and_contact_owners(self) -> None:
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["program_basename"], "step5d_strict_rnn_liveprep_v12")
        ...
        self.assertEqual(liveprep["local_delivery_evidence"]["controller_readback"], "runs/controller_readback_step5d_strict_rnn_liveprep_v12_20260615_212614")
        ...
        self.assertEqual(liveprep["guard"]["line_guard_low_load_stop_n"], 0.5)
        self.assertEqual(liveprep["guard"]["line_guard_tcp_speed_max_m_s"], 0.05)
        self.assertEqual(liveprep["guard"]["line_guard_contact_loss_limit_s"], 0.03)
        ...
        self.assertIn("v11 escape replay", liveprep["semantic_control_gate"]["failure_contrast"])
        self.assertIn("clears cmd_valid", liveprep["semantic_control_gate"]["failure_contrast"])
        self.assertTrue(any("v11 escape replay" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("0.050 rad/s" in gate for gate in liveprep["liveprep_gates"]))
        self.assertTrue(any("clears cmd_valid" in gate for gate in liveprep["liveprep_gates"]))
        self.assertEqual(liveprep["semantic_control_gate"]["stage25_line_guard"]["action"], "clear_cmd_valid_before_speedj")
