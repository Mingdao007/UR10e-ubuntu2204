...
def test_selected_v3_does_not_claim_deployment_motion_or_campaign_readiness() -> None:
    current = _load("config/current_stage.json")

    assert current["controller_readback_verified_for_selected_triplet"] is False
