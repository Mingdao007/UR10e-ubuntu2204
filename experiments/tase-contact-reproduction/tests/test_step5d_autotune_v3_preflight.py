...
def test_exact_v3_stopped_or_ready_home_program_binding() -> None:
    assert gate._program_safe_for_bridge(
        {"programState": "STOPPED /programs/andyl/kunwei/step5/step5d_strict_rnn_autotune_v3_r001.urp"},
    ...
    result = gate._program_safe_for_bridge(
        {"programState": "PLAYING /programs/andyl/kunwei/step5/step5d_strict_rnn_autotune_v3_r001.urp"},
        ready_home,
    )
