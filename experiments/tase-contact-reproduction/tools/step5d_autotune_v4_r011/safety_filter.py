...
from .common import R011ValueError, finite, json_tree, require_digest


SAFETY_SCHEMA = "step5d.autotune-v4/r011-path-safety-filter-v1"
...
class SafetyFilterError(R011ValueError):
...
class SafetyFilterConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if finite(self.max_state_age_s, "max_state_age_s") < 0.0 or finite(self.margin_tolerance, "margin_tolerance") < 0.0:
...
class SafetyIntervention:
    ...
    def __post_init__(self) -> None:
        ...
        require_digest(self.release_identity_sha256, "intervention release identity")
        require_digest(self.dispatch_identity_sha256, "intervention dispatch identity")
    ...
    def from_mapping(cls, value: Mapping[str, Any]) -> "SafetyIntervention":
        required = {"schema", "release_identity_sha256", "dispatch_identity_sha256", "nominal_command_m_s", "filtered_command_m_s", "intervention_norm_m_s", "remaining_margin", "objective_penalty", "force_objective_impact", "record_role"}
        ...
        return cls(value["release_identity_sha256"], value["dispatch_identity_sha256"], tuple(value["nominal_command_m_s"]), tuple(value["filtered_command_m_s"]), value["intervention_norm_m_s"], value["remaining_margin"], value["objective_penalty"], value["force_objective_impact"], value["schema"])

    def as_dict(self) -> dict[str, Any]:
        return {"schema": self.schema, "release_identity_sha256": self.release_identity_sha256, "dispatch_identity_sha256": self.dispatch_identity_sha256, "nominal_command_m_s": list(self.nominal_command_m_s), "filtered_command_m_s": list(self.filtered_command_m_s), "intervention_norm_m_s": self.intervention_norm_m_s, "remaining_margin": self.remaining_margin, "objective_penalty": False, "force_objective_impact": False, "record_role": "safety_event_not_objective"}
...
__all__ = [
    ...
    "INTERVENTION_SCHEMA", "MAX_ROOT_ITERATIONS", "SafetyFilterResult", "SafetyIntervention", "SafetyTimingReceipt", "benchmark_safety_filter", "filter_path_twist", "project_path_command", "reference_project_path_command",
]
