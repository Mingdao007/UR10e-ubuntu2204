...
PINNED_PATHS = (
    ...
    "experiments/tase-contact-reproduction/evidence/formal_motion_tracking_failure_20260809.json",
    ...
    "experiments/ur10e-variable-impedance/ur10e_vic/tacdiffusion/formal_tracking_quality.py",
