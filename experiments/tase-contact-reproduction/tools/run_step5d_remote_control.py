#!/usr/bin/env python3
"""Offline-safe CLI for the Step5d Remote preparation release."""
...
def _parser() -> argparse.ArgumentParser:
    ...
    check.add_argument("--prepared-trial", type=Path, required=True)
    ...
    try:
        ...
        if args.command == "status":
            result = {
                ...
                "offline_build_only": release.offline_build_only,
