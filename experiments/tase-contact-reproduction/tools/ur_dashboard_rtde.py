"""Shared minimal Dashboard and RTDE v2 clients.

This transport helper is intentionally stage-neutral.  It remains available to
the Step4/Step6 compatibility bridge after the legacy Step5d TP/autotune route
is removed.
"""
