...
def analyze_attempt(
    ...
    *,
    ...
    return {
        ...
        "interpretation": "Tangent slack cannot resolve samples infeasible in the hard normal/orientation tasks under the unchanged joint/slew bounds. The separate joint-only replay attributes each such row either to the slew-box intersection or to infeasibility already present under joint bounds. Such rows remain QP failures; this audit selects no slack value and does not authorize live use.",
    }
