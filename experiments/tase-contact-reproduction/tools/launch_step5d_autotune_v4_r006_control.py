#!/usr/bin/env python3
"""Managed owner-gated r006 control launcher.

The launcher resolves the canonical managed control interpreter and forwards a
manifest route.  It does not perform Dashboard Load/Play or open a transport.
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not arguments:
        raise SystemExit("usage: launch_step5d_autotune_v4_r006_control.py <manifest route> [args ...]")
