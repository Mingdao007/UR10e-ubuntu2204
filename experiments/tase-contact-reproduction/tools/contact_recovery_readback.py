...
def fetch_recovery_readback(output, package_dir=None):
    ...
    (output/'readback-results.json').write_text(json.dumps({'pass':True,'observed_at_s':observed,'scope':'fresh GET of installed recovery pair'},indent=2)+'\n')
    return output
