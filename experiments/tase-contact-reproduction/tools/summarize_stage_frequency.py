...
def summarize(csv_path: Path) -> dict:
    ...
    return {
        ...
        "stage24_v22_first_far_search_echo_rate": rate_for(24.0),
        "stage24_2_near_search_echo_rate": rate_for(24.2),
        "stage24_2_v22_first_near_search_echo_rate": rate_for(24.2),
        "stage24_3_v22_second_far_search_echo_rate": rate_for(24.3),
        "stage24_4_soft_acquisition_echo_rate": rate_for(24.4),
        "stage24_4_v22_second_near_search_echo_rate": rate_for(24.4),
        "stage25_05_latch_echo_rate": rate_for(25.05),
