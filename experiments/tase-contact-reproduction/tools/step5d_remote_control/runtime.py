...
def replay_jsonl(
    ...
    *,
    ...
    if not release.offline_build_only:
        raise RemoteControlError("Remote replay requires offline-only release")
    ...
    return {
        ...
        "execution_uid": getattr(release, "controller_config_sha256", None),
    }
