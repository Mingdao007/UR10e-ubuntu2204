...
BLOCKED_MARKER = (
    OUTPUT_DIR / "step5d_force_search_canary_r003.BLOCKED.json"
)
...
def source_stamp(now: datetime | None = None) -> str:
    ...
    return value.strftime("%Y-%m-%dT%H%MHKT_STEP5D_FORCE_SEARCH_CANARY_R003")
...
def write_triplet(output_dir: Path, stamp: str) -> dict[str, Any]:
    ...
    raise RuntimeError(
        "force-search r003 is superseded before live Play; "
