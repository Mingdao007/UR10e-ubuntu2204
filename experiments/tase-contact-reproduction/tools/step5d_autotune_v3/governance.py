...
RUNTIME_OBSERVATION_INTERVAL_S = 0.2
RUNTIME_OBSERVATION_INTERVAL_NS = int(
    RUNTIME_OBSERVATION_INTERVAL_S * 1_000_000_000
)
RUNTIME_OBSERVATION_MAX_AGE_NS = 5 * RUNTIME_OBSERVATION_INTERVAL_NS
BRIDGE_HEARTBEAT_MAX_AGE_NS = RUNTIME_OBSERVATION_MAX_AGE_NS
CONTROLLER_OBSERVATION_MAX_AGE_NS = 1_000_000_000
RTDE_OBSERVATION_MAX_AGE_NS = RUNTIME_OBSERVATION_MAX_AGE_NS
...
__all__ = [
    ...
    "RUNTIME_OBSERVATION_MAX_AGE_NS",
    "TRANSITION_TABLE",
