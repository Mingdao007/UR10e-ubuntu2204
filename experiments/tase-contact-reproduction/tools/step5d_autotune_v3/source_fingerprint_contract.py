...
EXPERIMENT_SOURCE_PATHS = frozenset({
    ...
    'tools/build_step5d_manual_tp_v1.py',
    ...
    'tools/promote_step5d_manual_release.py',
    ...
    'tools/step5d_manual_atomic_release.py',
    'tools/step5d_manual_bridge.py',
    'tools/step5d_manual_campaign_plan.py',
    'tools/step5d_manual_profile.py',
    'tools/step5d_manual_queue.py',
    'tools/step5d_manual_runtime.py',
