...
case "$1" in
  ...
  contact-bridge)
    ...
    STEP4E_TARGET_FORCE_N="${STEP4E_TARGET_FORCE_N:-${TASE_STEP5B_TARGET_FORCE_N}}" \
    BRIDGE_DURATION_S="${BRIDGE_DURATION_S:-${TASE_STEP5B_BRIDGE_DURATION_S}}" \
    MAX_NORMAL_FORCE_N="${MAX_NORMAL_FORCE_N:-${TASE_STEP5B_MAX_NORMAL_FORCE_N}}" \
    MAX_FORCE_NORM_N="${MAX_FORCE_NORM_N:-${TASE_STEP5B_MAX_FORCE_NORM_N}}" \
    MAX_TORQUE_NORM_NM="${MAX_TORQUE_NORM_NM:-${TASE_STEP5B_MAX_TORQUE_NORM_NM}}" \
    STEP4E_NORMAL_FOLLOW_MODE="${STEP4E_NORMAL_FOLLOW_MODE:-filtered_live}" \
    STEP4E_SKIP_BENCH_GATE="${STEP4E_SKIP_BENCH_GATE:-1}" \
    STEP4E_NORMAL_FILTER_ALPHA="${STEP4E_NORMAL_FILTER_ALPHA:-${TASE_STEP5B_NORMAL_FILTER_ALPHA}}" \
    STEP4E_NORMAL_MIN_FORCE_N="${STEP4E_NORMAL_MIN_FORCE_N:-${TASE_STEP5B_NORMAL_MIN_FORCE_N}}" \
    STEP4E_FORCE_P_GAIN="${STEP4E_FORCE_P_GAIN:-${TASE_STEP5B_FORCE_P_GAIN}}" \
    STEP4E_FORCE_I_GAIN="${STEP4E_FORCE_I_GAIN:-${TASE_STEP5B_FORCE_I_GAIN}}" \
    STEP4E_FORCE_DAMPING="${STEP4E_FORCE_DAMPING:-${TASE_STEP5B_FORCE_DAMPING}}" \
    STEP4E_ANGULAR_LIMIT_RAD_S="${STEP4E_ANGULAR_LIMIT_RAD_S:-${TASE_STEP5B_ANGULAR_LIMIT_RAD_S}}" \
    STEP4E_NORMAL_VELOCITY_LIMIT_M_S="${STEP4E_NORMAL_VELOCITY_LIMIT_M_S:-${TASE_STEP5B_NORMAL_VELOCITY_LIMIT_M_S}}" \
    STEP4E_TOTAL_LINEAR_LIMIT_M_S="${STEP4E_TOTAL_LINEAR_LIMIT_M_S:-${TASE_STEP5B_TOTAL_LINEAR_LIMIT_M_S}}" \
    STEP4E_REACQUIRE_VELOCITY_M_S="${STEP4E_REACQUIRE_VELOCITY_M_S:-${TASE_STEP5B_REACQUIRE_VELOCITY_M_S}}" \
    STEP4E_INTEGRAL_LIMIT_N_S="${STEP4E_INTEGRAL_LIMIT_N_S:-${TASE_STEP5B_INTEGRAL_LIMIT_N_S}}" \
