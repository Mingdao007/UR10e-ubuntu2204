...
Boundary:
  ...
  - Normal filter alpha: 0.70 default.
...
case "$1" in
  ...
  contact-bridge)
    ...
    STEP4E_NORMAL_FILTER_ALPHA="${STEP4E_NORMAL_FILTER_ALPHA:-0.70}" \
    STEP4E_NORMAL_MIN_FORCE_N="${STEP4E_NORMAL_MIN_FORCE_N:-2.0}" \
    STEP4E_FORCE_P_GAIN="${STEP4E_FORCE_P_GAIN:-0.0015}" \
    STEP4E_FORCE_I_GAIN="${STEP4E_FORCE_I_GAIN:-0.00002}" \
    STEP4E_FORCE_DAMPING="${STEP4E_FORCE_DAMPING:-5.0}" \
