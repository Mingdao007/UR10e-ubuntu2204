...
The entry no longer inherits the old RNN profile's 2.5 rad/s / 20 rad/s2 values: the native profile binds joint speed .05 rad/s and TP acceleration 5 rad/s2, with the existing proposal outer-loop normal .003 m/s, tangent .01 m/s and attitude .05 rad/s caps. The 80x20 mm figure-eight amplitude / 0.1 rad/s reference peaks at 4.47 mm/s; the inherited 4 mm/s tangential cap was still slightly below that bound.
